// This code simulates the gravitational interaction between multiple bodies in a 3D space.
...
#define MAX_MASS 10000     // Range for random mass value
...
int main(int argc, char *argv[]) {
    ...
    std::cout << "\nSequential runtime: " << elapsed.count() << " seconds\n";
